...
import { HeaderParams, RequestOptionsArgs, SearchParams } from './type'

export class BaseHttpService {
  static http: HttpClient

  protected http: HttpClient
  public apiVersion = 10
  ...
  protected resolveRequestContentType(
  ...
  protected resolveRequestHeaders(
  ...
  protected resolveRequestParams(
    params: SearchParams,
    options: RequestOptionsArgs = {}
  ): RequestOptionsArgs {
    return {
      ...options,
      params: { ...(options.params as any), ...(params as any) },
    }
  }
