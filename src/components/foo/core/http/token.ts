...
function clearLocalToken() {
  ;[sidKey, rsidKey, tokenKey, lastDateKey].forEach(
    key => (sessionStorage.removeItem(key), localStorage.removeItem(key))
  )
}
