...
const appDomain = encode(
  getObjectProp(client, 'appDomain') || getObjectProp(server, 'url', 'api')
)
...
export function updateSessionStorageObject<T>(key: string, value: T): T {
  return (
    setObject(
      sessionStorage,
      key,
      (value = merge({}, getSessionStorageObject(key), value))
    ),
    value
  )
}

export function setSessionStorageObjectKey<T>(
  key: string,
  ...
  return (
    setObject(
      sessionStorage,
      key,
      set(getSessionStorageObject(key), keyPath, value)
    ),
    value
  )
}

export function deleteSessionStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createSessionStorageScene(
  key: string,
  keyPath: string | string[]
) {
  const backKey = key
...
export function updateLocalStorageObject<T>(key: string, value: T): T {
  return (
    setObject(
      localStorage,
      key,
      (value = merge({}, getLocalStorageObject(key), value))
    ),
    value
  )
}

export function setLocalStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
  return (
    setObject(
      localStorage,
      key,
      set(getLocalStorageObject(key), keyPath, value)
    ),
    value
  )
}

export function deleteLocalStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createLocalStorageScene(
  key: string,
  keyPath: string | string[]
) {
  const backKey = key
...
export function setMemoryStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
...
export function deleteMemoryStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createMemoryStorageScene(
  key: string,
  keyPath: string | string[]
) {
  const backKey = key
...
export function updateStorageObject<T>(key: string, value: T): T {
  return (
    updateMemoryStorageObject(key, value),
    updateSessionStorageObject(key, value),
    updateLocalStorageObject(key, value)
  )
}

export function setStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
  return (
    ...
    setSessionStorageObjectKey(key, keyPath, value),
    setLocalStorageObjectKey(key, keyPath, value)
  )
}

export function deleteStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
  deleteMemoryStorageObjectKey(key, keyPath),
...
export function storageSceneFactory(
  key: string,
  keyPath: string | string[],
  ...storageCreaters: any[]
) {
  ...
  return {
    ...
    setObjectKey<T>(value: T): T {
      return (
        storages.forEach(storage => storage.setObjectKey(keyPath, value)), value
      )
    },
    deleteObjectKey() {
