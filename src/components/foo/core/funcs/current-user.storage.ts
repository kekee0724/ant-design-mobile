...
export function setCurrentUserSessionStorage(
  key: string,
  value: string
): string {
...
export function setCurrentUserSessionStorageObject<T>(
  key: string,
  value: T
): T {
...
export function updateCurrentUserSessionStorageObject<T>(
  key: string,
  value: T
): T {
...
export function setCurrentUserSessionStorageObjectKey<T>(
  key: string,
...
export function deleteCurrentUserSessionStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createCurrentUserSessionStorageScene(
  key: string,
  keyPath: string | string[]
) {
...
export function updateCurrentUserLocalStorageObject<T>(
  key: string,
  value: T
): T {
...
export function setCurrentUserLocalStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
...
export function deleteCurrentUserLocalStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createCurrentUserLocalStorageScene(
  key: string,
  keyPath: string | string[]
) {
...
export function updateCurrentUserMemoryStorageObject<T>(
  key: string,
  value: T
): T {
...
export function setCurrentUserMemoryStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
...
export function deleteCurrentUserMemoryStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createCurrentUserMemoryStorageScene(
  key: string,
  keyPath: string | string[]
) {
...
export function setCurrentUserStorageObjectKey<T>(
  key: string,
  keyPath: string | string[],
  value: T
): T {
...
export function deleteCurrentUserStorageObjectKey(
  key: string,
  keyPath: string | string[]
): void {
...
export function createCurrentUserStorageScene(
  key: string,
  keyPath: string | string[]
) {
...
export function storageCurrentUserFactory(
  key: string,
  ...storageCreaters: any[]
) {
